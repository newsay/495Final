...
if (authorize($auth_service, $organization_service)) {
  page_start($auth_service, "Scheduling OnDemand - View Profile", "Profile");
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 left-block" style="float:none">
        <div class="btn-group">
          <div onclick="editprofile.php">
            <a class="btn btn-default" href="editprofile.php"><span class="glyphicon glyphicon-pencil"></span> Edit Profile</a>
          </div>
        </div>
      </div>
    </div>
